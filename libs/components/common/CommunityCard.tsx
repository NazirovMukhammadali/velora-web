...
const CommunityCard = (props: CommunityCardProps) => {
	const { boardArticle, size = 'normal', likeArticleHandler: likeBoardArticleHandler, } = props;
		...
		return (
			...
			>
				...
				<Stack className="date-box">
					<span className="month">{formatDate(boardArticle?.createdAt, 'MMMM')}</span>
					<Typography className="day">{formatDate(boardArticle?.createdAt, 'dd')}</Typography>
				</Stack>
			</Stack>
		);
	}
